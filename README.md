...
- plotsell command, /plotsell <location> {amount=1}, Sells {amount} plots in {location}.
- plotcollect command, /plotcollect, Collects your daily maximum from each plot, can be used once a day.
- plotput command, /plotput <machine> <location> {amount=1}, Puts {amount} of <machine> at <location>'s plots.
- plottake command, /plottake <machine> <location> {amount=1}, Takes {amount} of <machine> at <location>'s plots.
